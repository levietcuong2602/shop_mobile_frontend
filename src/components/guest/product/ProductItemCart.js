...
class ProductItemCart extends Component {
  ...
  render() {
    const {
      ...
      addProductFavorites,
      deleteProductCart,
      changeAmountProductCartSub,
      changeAmountProductCartPlus,
      handleSelectProduct,
    } = this.props;
            ...
            <div id="product_item_cart" key={index}>
              <div className="product_cart">
                <div className="checkbox_image">
                  ...
                  />
                  <img src={product.product_product_images} alt="ảnh" />
                </div>
                <div className="info_product_cart">
                  <span className="product_name">
                    {product.product_product_name}
                  </span>
                  <span className="producer">
                    {product.product_description}
                  </span>
                  <span className="price">
                    {formatNumber(product.product_base_price)} VNĐ
                  </span>
                  <div>
                    <span
                      className="icon_heart"
                      onClick={() => addProductFavorites(product.id)}
                    >
                      <a href="#">
              ...
              <div className="price_count_cart">
                <div className="button_itemcart">
                  <button
                    ...
                    onClick={() => changeAmountProductCartSub(index)}
                  >
                    -
                  </button>
                  ...
                  <button
                    type="button"
                    className="btn btn-large btn-block btn-default"
                    onClick={() => changeAmountProductCartPlus(index)}
                  >
                    +
                  </button>
                </div>
